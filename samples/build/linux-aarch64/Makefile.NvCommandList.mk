...
NvCommandList_debug_lpaths    += ./../../../extensions/lib/linux-aarch64
NvCommandList_debug_lpaths    += ./../../../extensions/externals/lib/linux-aarch64
...
NvCommandList_debug_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
NvCommandList_debug_cppflags  += -Wno-reorder
...
NvCommandList_debug_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
NvCommandList_debug_bin      := ./../../bin/linux-aarch64/NvCommandListD
...
$(NvCommandList_debug_bin): $(NvCommandList_debug_obj) build_NsFoundation_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvModel_debug build_NvGLUtils_debug build_NvGamepad_debug build_NvImage_debug build_NvUI_debug build_Half_debug 
	mkdir -p `dirname ./../../bin/linux-aarch64/NvCommandListD`
...
NvCommandList_release_lpaths    += ./../../../extensions/lib/linux-aarch64
NvCommandList_release_lpaths    += ./../../../extensions/externals/lib/linux-aarch64
...
NvCommandList_release_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
NvCommandList_release_cppflags  += -Wno-reorder
...
NvCommandList_release_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
NvCommandList_release_bin      := ./../../bin/linux-aarch64/NvCommandList
...
$(NvCommandList_release_bin): $(NvCommandList_release_obj) build_NsFoundation_release build_NvAppBase_release build_NvAssetLoader_release build_NvModel_release build_NvGLUtils_release build_NvGamepad_release build_NvImage_release build_NvUI_release build_Half_release 
	mkdir -p `dirname ./../../bin/linux-aarch64/NvCommandList`
