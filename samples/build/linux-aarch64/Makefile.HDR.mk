...
HDR_debug_lpaths    := 
HDR_debug_lpaths    += ./../../../extensions/lib/linux-aarch64
HDR_debug_lpaths    += ./../../../extensions/externals/lib/linux-aarch64
...
HDR_debug_libraries += Xinerama
HDR_debug_libraries += Xcursor
...
HDR_debug_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
HDR_debug_cppflags  += -Wno-reorder -std=c++11
...
HDR_debug_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
HDR_debug_bin      := ./../../bin/linux-aarch64/HDRD
...
$(HDR_debug_bin): $(HDR_debug_obj) build_NsFoundation_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvModel_debug build_NvGLUtils_debug build_NvGamepad_debug build_NvImage_debug build_NvUI_debug build_Half_debug 
	mkdir -p `dirname ./../../bin/linux-aarch64/HDRD`
	$(CCLD) $(filter %.o, $(HDR_debug_obj)) $(HDR_debug_lflags) -o $(HDR_debug_bin) 
...
HDR_release_lpaths    := 
HDR_release_lpaths    += ./../../../extensions/lib/linux-aarch64
HDR_release_lpaths    += ./../../../extensions/externals/lib/linux-aarch64
...
HDR_release_libraries += Xinerama
HDR_release_libraries += Xcursor
...
HDR_release_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
HDR_release_cppflags  += -Wno-reorder -std=c++11
...
HDR_release_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
HDR_release_bin      := ./../../bin/linux-aarch64/HDR
...
$(HDR_release_bin): $(HDR_release_obj) build_NsFoundation_release build_NvAppBase_release build_NvAssetLoader_release build_NvModel_release build_NvGLUtils_release build_NvGamepad_release build_NvImage_release build_NvUI_release build_Half_release 
	mkdir -p `dirname ./../../bin/linux-aarch64/HDR`
	$(CCLD) $(filter %.o, $(HDR_release_obj)) $(HDR_release_lflags) -o $(HDR_release_bin) 
	$(ECHO) building $@ complete!
