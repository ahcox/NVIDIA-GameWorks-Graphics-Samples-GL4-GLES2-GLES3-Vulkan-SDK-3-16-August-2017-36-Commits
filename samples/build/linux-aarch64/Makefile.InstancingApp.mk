...
InstancingApp_debug_lpaths    += ./../../../extensions/lib/linux-aarch64
InstancingApp_debug_lpaths    += ./../../../extensions/externals/lib/linux-aarch64
...
InstancingApp_debug_libraries += Xinerama
InstancingApp_debug_libraries += Xcursor
...
InstancingApp_debug_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
InstancingApp_debug_cppflags  += -Wno-reorder -std=c++11
...
InstancingApp_debug_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
InstancingApp_debug_bin      := ./../../bin/linux-aarch64/InstancingAppD
...
$(InstancingApp_debug_bin): $(InstancingApp_debug_obj) build_NsFoundation_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvModel_debug build_NvGLUtils_debug build_NvGamepad_debug build_NvImage_debug build_NvUI_debug build_Half_debug 
	mkdir -p `dirname ./../../bin/linux-aarch64/InstancingAppD`
	$(CCLD) $(filter %.o, $(InstancingApp_debug_obj)) $(InstancingApp_debug_lflags) -o $(InstancingApp_debug_bin) 
...
InstancingApp_release_lpaths    += ./../../../extensions/lib/linux-aarch64
InstancingApp_release_lpaths    += ./../../../extensions/externals/lib/linux-aarch64
...
InstancingApp_release_libraries += Xinerama
InstancingApp_release_libraries += Xcursor
...
InstancingApp_release_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
InstancingApp_release_cppflags  += -Wno-reorder -std=c++11
...
InstancingApp_release_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
InstancingApp_release_bin      := ./../../bin/linux-aarch64/InstancingApp
...
$(InstancingApp_release_bin): $(InstancingApp_release_obj) build_NsFoundation_release build_NvAppBase_release build_NvAssetLoader_release build_NvModel_release build_NvGLUtils_release build_NvGamepad_release build_NvImage_release build_NvUI_release build_Half_release 
	mkdir -p `dirname ./../../bin/linux-aarch64/InstancingApp`
	$(CCLD) $(filter %.o, $(InstancingApp_release_obj)) $(InstancingApp_release_lflags) -o $(InstancingApp_release_bin) 
	$(ECHO) building $@ complete!
