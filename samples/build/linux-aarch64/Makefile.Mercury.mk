...
Mercury_debug_lpaths    += ./../../../extensions/lib/linux-aarch64
Mercury_debug_lpaths    += ./../../../extensions/externals/lib/linux-aarch64
...
Mercury_debug_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
Mercury_debug_cppflags  += -Wno-reorder
...
Mercury_debug_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
Mercury_debug_bin      := ./../../bin/linux-aarch64/MercuryD
...
$(Mercury_debug_bin): $(Mercury_debug_obj) build_NsFoundation_debug build_NvAppBase_debug build_NvAssetLoader_debug build_NvModel_debug build_NvGLUtils_debug build_NvGamepad_debug build_NvImage_debug build_NvUI_debug build_Half_debug 
	mkdir -p `dirname ./../../bin/linux-aarch64/MercuryD`
...
Mercury_release_lpaths    += ./../../../extensions/lib/linux-aarch64
Mercury_release_lpaths    += ./../../../extensions/externals/lib/linux-aarch64
...
Mercury_release_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
Mercury_release_cppflags  += -Wno-reorder
...
Mercury_release_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
Mercury_release_bin      := ./../../bin/linux-aarch64/Mercury
...
$(Mercury_release_bin): $(Mercury_release_obj) build_NsFoundation_release build_NvAppBase_release build_NvAssetLoader_release build_NvModel_release build_NvGLUtils_release build_NvGamepad_release build_NvImage_release build_NvUI_release build_Half_release 
	mkdir -p `dirname ./../../bin/linux-aarch64/Mercury`
